...
2. Once the song title/artist is identified (or if the query was already a song name), call the search_music_hebrew (or search_music_english) tool to get the top candidate tracks from Spotify.
